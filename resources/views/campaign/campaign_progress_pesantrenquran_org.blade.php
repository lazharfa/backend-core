...
<head>
    ...
    <title>Pesantren Quran Taqwa</title>
    <style type="text/css">
            ...
            <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" bgcolor="#ffffff">
                <tr>
                    <td colspan="5" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff; font-size: 14px; font-family: Helvetica, sans-serif; color: #333;padding:20px;">
                        <img src="https://www.pesantrenquran.org/resources/members/pesantrenquran/org/logo.png" alt=""/>
                ...
                <tr>
                    ...
                    <td colspan="5" class="container-padding" bgcolor="#ffffff" style="border-bottom: 1px solid #edeff0;padding-left: 20px;padding-right: 20px;padding-top: 20px;padding-bottom: 40px;background-color: #ffffff; font-size: 14px; font-family: Helvetica, sans-serif; color: #333;">
                        ...
                        <p style="color:#6b6b6b;line-height: 24px;font-family: Helvetica, sans-serif;font-weight: 300;font-size: 14px;">
                            Assalamu'alaikum sahabat <b>{{ $donation->donor_name }}</b>
                            <br/>
                            Donasimu sudah disalurkan, berikut update <span style="font-weight:bold;">{{ $campaignProgress->campaign->campaign_title }}.</span>
                        ...
                        <p style="margin:40px 0 10px 0;color:#6b6b6b;line-height: 24px;font-family: Helvetica, sans-serif;font-weight: 300;font-size: 14px;">
                            ...
                            <img src="{{ 'https://core.pesantrenquran.org/api/image/' . $campaignProgress->news_image }}">
                            @endif

                        </p>

                        <p style="margin:40px 0 10px 0;color:#6b6b6b;line-height: 24px;font-family: Helvetica, sans-serif;font-weight: 300;font-size: 14px;">
                            Berita selengkapnya dapat sahabat akses melalui link berikut ini.
                            Terima kasih sudah menjadi bagian dari Sahabat Beramal Mulia. <a href="{{ 'https://www.pesantrenquran.org/id/post/' . $campaignProgress->news_slug }}">link berikut</a>
                        </p>
                        

                        <p style="margin:40px 0 10px 0;color:#6b6b6b;line-height: 24px;font-family: Helvetica, sans-serif;font-weight: 300;font-size: 14px;">
                            Mari bantu campaign lainnya di https://www.pesantrenquran.org/id/campaign
                        </p>
                        ...
                        <hr style="margin:10px 0; border:none;">
                        <span style="color:#6b6b6b;">Adhilla</span>
                        <hr style="margin:20px 0; border:none;">
                        <span style="color:#6b6b6b;font-style:italic;">Customer Relation</span>
                        <hr style="margin:10px 0; border:none;">
                        <span style="color:#6b6b6b;">Pesantren Quran Taqwa</span>
                        </p>
