    ...
    <tr>
        <td align="center" valign="top" bgcolor="#edeff0" style="background-color: #edeff0;">
            ...
            <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" bgcolor="#ffffff">
                <tr>
                    <td colspan="5" class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff; font-size: 14px; font-family: Helvetica, sans-serif; color: #333;padding:20px; padding-left: 0px">
                        <img height="75px" src="https://kaunyberbagi.com/assets/logo.png" alt=""/>
                ...
                <tr>
                    ...
                    <td colspan="5" class="container-padding" bgcolor="#ffffff" style="border-bottom: 1px solid #edeff0;padding-left: 20px;padding-right: 20px;padding-top: 20px;padding-bottom: 40px;background-color: #ffffff; font-size: 14px; font-family: Helvetica, sans-serif; color: #333;">
                        ...
                        <p style="color:#6b6b6b;line-height: 24px;font-family: Helvetica, sans-serif;font-weight: 300;font-size: 14px;">
                            Halo <b>{{ $donation->donor_name }}</b>
                            <br/>
                            Berikut update dari program <span style="font-weight:bold;">{{ $campaignProgress->campaign->campaign_title }}.</span>
                        ...
                        <p style="margin:40px 0 10px 0;color:#6b6b6b;line-height: 24px;font-family: Helvetica, sans-serif;font-weight: 300;font-size: 14px;">
                            ...
                            @if($campaignProgress->news_image)
                                <img src="{{ 'https://core.kaunyberbagi.com/api/image/' . $campaignProgress->news_image }}">
                            @endif

                        </p>

                        <p style="margin:40px 0 10px 0;color:#6b6b6b;line-height: 24px;font-family: Helvetica, sans-serif;font-weight: 300;font-size: 14px;">
                            Cerita lengkapnya bisa dilihat di <a href="{{ 'https://www.kaunyberbagi.com/id/post/' . $campaignProgress->news_slug }}">link berikut</a>
                        </p>
                        ...
                        <p style="margin:40px 0 10px 0;color:#6b6b6b;line-height: 24px;font-family: Helvetica, sans-serif;font-weight: 300;font-size: 14px;">
                            Bantu program lainnya https://www.kaunyberbagi.com/id/campaign
                        </p>
