...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		#templatePreheader{
			/*@editable*/background-color:#{{ $background_color }};
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="{{ $logo }}" width="150" style="max-width:150px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <p>Halo Bapak/Ibu <strong>{{ $donor->full_name }}</strong><br>
Berikut berita terbaru dari program yang Anda bantu, <strong>{{ $campaignProgress->campaign->campaign_title }}</strong></p>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h2><strong>{{ $campaignProgress->news_title }}</strong></h2><br>
							<p>
								<a target="_blank" href="{{ 'https://' . $member .  '/id/post/' . $campaignProgress->news_slug }}" style="color: #007DBE">
					                <img src="{{ 'https://core.' . $member . '/api/image/' . $campaignProgress->news_image }}" class="gambar" width="300px">
					            </a>
							</p>
                        </td>
                    </tr>
...
-->
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <p>Anda dapat melihat perkembangan donasi program ini, atau lihat program lainnya di bawah ini.</p>
											    ...
											    <tbody class="mcnButtonBlockOuter">
											        <tr>
											            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
											                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 2px none #007DBE;border-radius: 8px;background-color: #2D65A1;">
											                    <tbody>
											                        <tr>
											                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Source Sans Pro&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 18px;">
											                                <a class="mcnButton " title="Lihat Program Ini" href="https://{{ $member }}/id/campaign/{{ $campaignProgress->campaign->campaign_slug }}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Lihat Program Ini</a>
											                            </td>
											                        </tr>
											                    </tbody>
											                </table>
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 2px solid #2D65A1;border-radius: 8px;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Source Sans Pro&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 18px;">
                                <a class="mcnButton " title="Program Lainnya" href="https://{{ $member }}/id/campaign" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #2D65A1;">Program Lainnya</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody><tr>
                        ...
                        <td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">
                            ...
                            <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width:100% !important;">
                                <tbody><tr>
                                    <td valign="top" class="mcnTextContent" style="padding: 18px; font-weight: normal; line-height: 125%;">
                                        <div style="text-align: center;">Copyright © {{ date('Y') }} {{ $app_name }}<br>
<a href="mailto:{!! 'customer@' . $member !!}" target="_blank">{!! 'customer@' . $member !!}</a><br>
<br>
E-mail ini dikirimkan kepada donatur {{ $app_name }} sebagai media komunikasi program dan layanan. Semoga sinergi kebaikan dapat terus terjalin.</div>
