                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        @foreach($donations as $donation)
                            <tr>
                                ...
                                <td>{{ isset($donation->category_name) ? $donation->category_name : '' }}</td>
                                <td>{{ $donation->total_transaction }}</td>
                                <td>{{ $donation->total_donation }}</td>
                                <td>
                                    <a class="btn btn-primary" href="{{ url('donation/' . $donation->id) }}">Detail</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
